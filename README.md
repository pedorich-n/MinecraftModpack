...
- [**Auto Elytra**](https://modrinth.com/mod/auto-elytra) (client, 2.1.3) - A client side mod that automatically switches your elytra and chestplate when you go to fly.
...
- [**Connector Extras**](https://modrinth.com/mod/connector-extras) (both, 1.11.2+1.20.1) - Integrating Connector with third-party APIs
- [**Sinytra Connector**](https://modrinth.com/mod/connector) (both, 1.0.0-beta.44+1.20.1) - The Fabric Compatibility Layer for Minecraft Forge
- [**Controlify**](https://modrinth.com/mod/controlify) (client, 2.0.0-beta.10+1.20.1) - Adds the best controller support to Minecraft Java edition!
...
- [**Entity Culling**](https://modrinth.com/mod/entityculling) (client, 1.6.6) - Using async path-tracing to hide Block-/Entities that are not visible
- [**Explorify**](https://modrinth.com/mod/explorify) (both, 1.4.0) - A simplistic, vanilla-friendly collection of new structures.
...
- [**Forgified Fabric API**](https://modrinth.com/mod/forgified-fabric-api) (both, 0.92.2+1.11.8+1.20.1) - Fabric API implemented on top of MinecraftForge
...
- [**AutoTools**](https://modrinth.com/mod/minecraft_autotools) (client, 2.1.1) - AutoTools is a Minecraft mod that allows you to automatically switch to the best tool for blocks/mobs with the press of a button. It looks through your whole inventory and choses the best tool according to mining level/speed, damage and enchantments.
...
- [**Nimble**](https://modrinth.com/mod/nimble) (client, 5.0.1) - Perspective animation · Auto third person · Elytra camera roll
...
- [**Open Parties and Claims**](https://modrinth.com/mod/open-parties-and-claims) (both, forge-1.20.1-0.23.1) - Adds the ability to claim chunks and make player parties, integrates with Xaero's Minimap and World Map
...
- [**YetAnotherConfigLib**](https://modrinth.com/mod/yacl) (client, 3.4.2+1.20.1-forge) - A builder-based configuration library for Minecraft.
